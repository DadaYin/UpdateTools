...
void UpdateWidget::OnGetJsonBtnClicked()
{
    DownloadJsonFile();
}
...
void UpdateWidget::OnDownLoadError(QString fullFileName, QString relativeName, QNetworkReply::NetworkError err)
{

}

void UpdateWidget::OnTextChanged()
{
...
void UpdateWidget::InitConnector()
{
...
bool UpdateWidget::DownloadJsonFile()
{
...
int UpdateWidget::GetJsonContent(const QString &_fileName, UpdateJsonInfo &_jsonInfo, ErrorCode &_err)
{
...
int UpdateWidget::CompareUpdateJson(const UpdateJsonInfo &_jsonInfo1, const UpdateJsonInfo &_jsonInfo2, QList<OneUpdateFileInfo> &_fileInfoList)
{
...
int UpdateWidget::GetFileMapFromList(const QList<OneUpdateFileInfo> &_fileInfoList, QMap<QString, OneUpdateFileInfo> &_fileInfoMap)
{
...
void UpdateWidget::AppendTextStr(QString str)
{
//    QString originStr = textEdit_->toPlainText();
    QString originStr = QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss.zzz") + "---" + str;
    textEdit_->append(originStr);
}

void UpdateWidget::StartCheckMD5()
{
    AppendTextStr("***************************");
    AppendTextStr("下载完成");
    AppendTextStr("***************************");
...
bool UpdateWidget::CheckMD5(const QString &_TmpUpdateDir, const QMap<QString, OneUpdateFileInfo> &_oneInfo)
{
...
bool UpdateWidget::CheckOneMD5(const QString &_TmpUpdateDir, const OneUpdateFileInfo &_oneInfo)
{
...
bool UpdateWidget::copyFileToPath(QString _sourceDir, QString _toDir, bool _coverFileIfExist)
{
    _toDir.replace("\\","/");
...
bool UpdateWidget::copyDirectoryFiles(QString fromDir, QString toDir, bool _coverFileIfExist)
{
...
QByteArray UpdateWidget::getFileMd5(const QString &_fileName)
{
